...
////433无线信号指示端口*/
//#define SIGNAL		1		//是否需要信号指示功能 1: 需要， 0：不需要
//#define SIGNAL_PORT	GPIO_B
//#define SIGNAL_PIN	pin_9
...
#define GREEN_ON	STATUS0(GREEN_PORT, GREEN_PIN)
#define GREEN_OFF	STATUS1(GREEN_PORT, GREEN_PIN)

#define RED_PORT	GPIO_B
#define RED_PIN		pin_8
#define RED_ON		STATUS0(RED_PORT, RED_PIN)
#define RED_OFF		STATUS1(RED_PORT, RED_PIN)
